...
*******************************************************************************/
/*directory*/
libname data ".\data_timepoint";
libname ModDir ".\module_timepoint";
%********** 2-state **********;

%Macro sim_MHMM_tp(start,end,output,obs);
proc iml;
...
run;
%Mend sim_MHMM_tp;
%sim_MHMM_tp(1001,1100,boot_dm_TP20_1,20);
%sim_MHMM_tp(1101,1200,boot_dm_TP20_2,20);
%sim_MHMM_tp(1201,1300,boot_dm_TP20_3,20);
%sim_MHMM_tp(1301,1400,boot_dm_TP30_1,30);
%sim_MHMM_tp(1401,1500,boot_dm_TP30_2,30);
%sim_MHMM_tp(1501,1600,boot_dm_TP30_3,30);
%sim_MHMM_tp(1601,1700,boot_dm_TP40_1,40);
%sim_MHMM_tp(1701,1800,boot_dm_TP40_2,40);
%sim_MHMM_tp(1801,1900,boot_dm_TP40_3,40);
/*%sim_MHMM(1901,2200,boot_dm_S_4);*/
